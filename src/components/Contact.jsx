      ...
      <div className="container px-5 py-10 mx-auto flex sm:flex-nowrap flex-wrap">
        <div className="lg:w-2/3 md:w-1/2 bg-gray-900 rounded-lg overflow-hidden sm:mr-10 p-10 flex items-end justify-start relative">
          <iframe
            ...
            src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d12085.199083021053!2d-111.8984555707308!3d40.777423392991906!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x8752f511bd28ae05%3A0xec6d0cba75d8fd4a!2sUtah%20State%20Capitol!5e0!3m2!1sen!2sus!4v1690246396564!5m2!1sen!2sus"
          />
          <div className="bg-gray-900 relative flex flex-wrap py-6 rounded shadow-md">
            ...
            <div className="lg:w-1/2 px-4 mt-4 lg:mt-0">
              ...
              <a className="text-white leading-relaxed">
                calvin.matsonroberts@outlook.com
              </a>
              <h2 className="title-font font-semibold text-yellow-500  tracking-widest text-xs mt-4">
                PHONE
              </h2>
              <p className="leading-relaxed text-white">801-555-5555</p>
            </div>
          </div>
        </div>
        <form
        ...
        >
          ...
          <button
            type="submit"
            className="text-white bg-gray-900 border-0 py-2 px-6 focus:outline-none hover:bg-yellow-500 rounded text-lg"
          >
            Submit
          </button>
        </form>
